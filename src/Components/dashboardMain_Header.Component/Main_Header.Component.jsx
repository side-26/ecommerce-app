...
const MainHeader = ({ clss, clss2, bg, fs, txt, txt2,Isorder,deliverd,deliverdFu }) => {
    return (
        <header className={clss}>
            <Title txt={txt2} clss={clss2}>
            </Title>
            {!Isorder?<Button variant="contained" sx={{ backgroundColor: `${bg}`, fontSize: `${fs}`, fontFamily: "IranSansRegular", width: "8rem", height: "3rem" }}>
                {txt}
            </Button>:
